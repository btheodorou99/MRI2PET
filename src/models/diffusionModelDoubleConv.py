...
class DiffusionModel(nn.Module):
    def __init__(self, config, noise=False):
        ...
        self.inc = DoubleConv(config.n_pet_channels, 64)
        
        self.down1 = DoubleConv(64, 64, self.embed_dim)
        self.sa1 = LinearAttention(64)
        self.down2 = DoubleConv(64, 64, self.embed_dim)
        self.sa2 = LinearAttention(64)
        self.down3 = DoubleConv(64, 64, self.embed_dim)
        self.sa3 = LinearAttention(64)
        self.down4 = DoubleConv(64, 64, self.embed_dim)
        ...
        self.up1 = DoubleConv(96, 64, self.embed_dim)
        self.sa5 = LinearAttention(64)
        self.up2 = DoubleConv(96, 64, self.embed_dim)
        self.sa6 = LinearAttention(64)
        self.up3 = DoubleConv(96, 64, self.embed_dim)
        self.sa7 = LinearAttention(64)
        self.up4 = DoubleConv(96, 64, self.embed_dim)
        self.sa8 = LinearAttention(64)
        self.outc = nn.Conv2d(64, config.n_pet_channels, kernel_size=1)
