...
class DiffusionModel(nn.Module):
    ...
    def forward(self, context, input_images, gen_loss=True, weight=0.0):
        ...
        if gen_loss:
            ...
            wavelet_mri_loss = self.wavelet_scattering_transform_loss(context, predictedImage)
            return loss + self.lambda1 * wavelet_loss + weight * wavelet_mri_loss, predictedNoise
