# Adaptive Frequency Loss Beginning With Emphasis on Low Frequency Features and Ending With Emphasis on High Frequency Features
...
class DiffusionModel(nn.Module):
    ...
    def compute_high_freq_loss(self, x_T, x_R, weights):
        ...
        return lf_weight * lf_mse_loss + hf_weight * hf_mse_loss
