...
from ..models.proposedModel11 import DiffusionModel
...
if os.path.exists(f"./src/save/proposedModel11.pt"):
    print("Loading previous model")
    checkpoint = torch.load(f'./src/save/proposedModel11.pt', map_location=torch.device(device))
...
#         'mode': 'pretrain'
#     }
#     torch.save(state, f'./src/save/proposedModel11.pt')
