...
input_mri_dir = "./src/data/MRI/"
output_mri_dir = "./src/data/MRI_Processed/"
input_pet_dir = "./src/data/PET/"
output_pet_dir = "./src/data/PET_Processed/"
...
pet_paths = [p for (m, p) in pickle.load(open('./src/data/pet_mri_pairs.pkl', 'rb'))]
