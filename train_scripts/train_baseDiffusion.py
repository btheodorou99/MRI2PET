...
if os.path.exists(f"../save/baseDiffusion.pt"):
    print("Loading previous model")
    checkpoint = torch.load(f'../save/baseDiffusion.pt', map_location=torch.device(device))
...
for e in tqdm(range(config.epoch)):
    ...
    with torch.no_grad():
        ...
        torch.save(state, f'../save/baseDiffusion.pt')