...
if os.path.exists(f"../save/selfPretrainedDiffusion.pt"):
    print("Loading previous model")
    checkpoint = torch.load(f'../save/selfPretrainedDiffusion.pt', map_location=torch.device(device))
...
for e in tqdm(range(config.pretrain_epoch)):
    ...
    torch.save(state, f'../save/selfPretrainedDiffusion.pt')
